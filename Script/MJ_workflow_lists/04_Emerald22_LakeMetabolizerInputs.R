...
year <- 2022 #desired open water period
...
load("Emerald_2022_winter_data.rdata")
...
sensor_data <- sensor_data[with(sensor_data, datetime >= "2022-07-17 14:00:00" & datetime <= "2022-10-30 17:00:00"),]
...
sensor_data$shading = ifelse(sensor_data$light_2.72 > 10000, 1, 0)
