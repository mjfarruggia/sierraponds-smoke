...
load("Topaz_2023_winter_data.rdata")
...
sensor_data <- sensor_data[with(sensor_data, datetime >= "2022-07-20 17:00:00" & datetime <= "2022-10-30 17:00:00"),]
...
sensor_data$shading = ifelse(sensor_data$light_2.68 > 10000, 1, 0)
...
thermo <- ts.thermo.depth(wtr=wtr, Smin=0.1)#need to play with Smin parameter
